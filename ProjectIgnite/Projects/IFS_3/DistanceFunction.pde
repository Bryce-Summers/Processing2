...
class DistanceFunctionProcessor
{
  ...
  void colorUsingDistanceFunction(double[][] cache)
  {
    this.cache = cache;
  ...
  // This is used for the hyperspeed animatable version of the distance function.
  void addPoint(int row, int col)
  {
    Q.add(new DistanceRecord(row, col, row, col));
  }
